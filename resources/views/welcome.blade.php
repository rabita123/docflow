...
<section class="section" id="tools">
  ...
  <div class="tools-grid" id="tools-grid">
    ...
    <div class="tc" data-c="edit" onclick="window.location='/highlight-pdf'"><div class="tc-icon-wrap c-yellow">🖊️</div><div class="tc-name">Highlight PDF</div><div class="tc-desc">Highlight, underline &amp; annotate any PDF free</div><span class="tc-badge bnew">NEW</span></div>
