...
@section('title', 'Translate PDF to Chinese Free — PDF中文翻译在线')
@section('description', 'Translate PDF to Chinese (Simplified) online free. AI translation supports Simplified and Traditional Chinese. No signup, accurate and fast.')
@section('keywords', 'translate pdf to chinese, pdf to chinese translator, pdf chinese translation free, translate pdf chinese online, pdf to mandarin, pdf中文翻译')
@section('slug', 'translate-pdf-to-chinese')
@section('schema')
<script type="application/ld+json">
[{"@context":"https://schema.org","@type":"SoftwareApplication","name":"PDFTash — Translate PDF to Chinese","applicationCategory":"WebApplication","operatingSystem":"Any","description":"Free AI tool to translate any PDF to Chinese (Simplified and Traditional) online. No signup required.","url":"https://pdftash.com/translate-pdf-to-chinese","offers":{"@type":"Offer","price":"0","priceCurrency":"USD"},"aggregateRating":{"@type":"AggregateRating","ratingValue":"4.8","reviewCount":"1290"}},
{"@context":"https://schema.org","@type":"FAQPage","mainEntity":[
{"@type":"Question","name":"Does PDFTash translate to Simplified or Traditional Chinese?","acceptedAnswer":{"@type":"Answer","text":"PDFTash defaults to Simplified Chinese (普通话/简体字). For Traditional Chinese, specify in your request or use the main Translate PDF tool."}},
{"@type":"Question","name":"Is PDF to Chinese translation free?","acceptedAnswer":{"@type":"Answer","text":"Yes. Free users get 1 translation per day with no signup. Pro users get unlimited."}},
{"@type":"Question","name":"Can I translate a Chinese PDF to English?","acceptedAnswer":{"@type":"Answer","text":"Yes — use our Translate PDF tool and select English as the target language."}}
]}]
</script>
@endsection
@section('content')
<div class="hero">
  <div style="display:flex;gap:8px;justify-content:center;flex-wrap:wrap;margin-bottom:20px;">
    <div class="badge">🇨🇳 PDF to Chinese</div>
    <div class="badge" style="background:rgba(0,229,160,.1);border-color:rgba(0,229,160,.4);color:#00e5a0;">🆓 Free</div>
  </div>
  <h1>Translate PDF to Chinese — PDF中文翻译</h1>
  <p>AI-powered Chinese translation for any PDF. Simplified and Traditional Chinese supported. No signup, accurate, instant download.</p>
</div>
<div class="tool-box">
  <div class="upload-area" id="drop-zone" onclick="document.getElementById('pdfInput').click()">
    <div class="upload-icon">🇨🇳</div>
    <div class="upload-title">Drop your PDF here to Translate to Chinese</div>
...
<div style="max-width:700px;margin:0 auto 60px;padding:0 20px;text-align:center;">
  ...
  <div style="display:flex;gap:10px;flex-wrap:wrap;justify-content:center;">
    @foreach([['🇧🇩 Bengali','/pdf-translator-bengali'],['🇯🇵 Japanese','/translate-pdf-to-japanese'],['🇮🇳 Hindi','/translate-pdf-to-hindi'],['🇪🇸 Spanish','/translate-pdf-to-spanish'],['🌐 All Languages','/translate-pdf']] as $l)
...
async function processTranslate(){
    ...
    let secs=0;result.innerHTML='<div style="color:#8888a8;padding:20px">⏳ Translating to Chinese... <span id="timer">0s</span></div>';
    const iv=setInterval(()=>{secs++;const t=document.getElementById('timer');if(t)t.textContent=secs+'s';},1000);
    const fd=new FormData();fd.append('file',selectedFile);fd.append('language','Chinese');fd.append('_token',CSRF);
