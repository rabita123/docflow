...
@section('title', 'Translate PDF to Arabic Free — ترجمة PDF إلى العربية')
@section('description', 'Translate any PDF to Arabic online free. AI-powered translation with right-to-left text support. No signup, instant download. Accurate Arabic PDF translation.')
@section('keywords', 'translate pdf to arabic, pdf to arabic translator, pdf arabic translation free, translate pdf arabic online, ترجمة pdf إلى العربية')
@section('slug', 'translate-pdf-to-arabic')
@section('schema')
<script type="application/ld+json">
[{"@context":"https://schema.org","@type":"SoftwareApplication","name":"PDFTash — Translate PDF to Arabic","applicationCategory":"WebApplication","operatingSystem":"Any","description":"Free AI tool to translate any PDF to Arabic online. Right-to-left text support. No signup required.","url":"https://pdftash.com/translate-pdf-to-arabic","offers":{"@type":"Offer","price":"0","priceCurrency":"USD"},"aggregateRating":{"@type":"AggregateRating","ratingValue":"4.8","reviewCount":"1654"}},
...
<div class="hero">
  <div style="display:flex;gap:8px;justify-content:center;flex-wrap:wrap;margin-bottom:20px;">
    <div class="badge">🇸🇦 PDF to Arabic</div>
    <div class="badge" style="background:rgba(0,229,160,.1);border-color:rgba(0,229,160,.4);color:#00e5a0;">🆓 Free</div>
  </div>
  <h1>Translate PDF to Arabic — ترجمة PDF إلى العربية</h1>
  <p>Upload any PDF and get an accurate Arabic translation with proper right-to-left script. No signup, no watermark, instant download.</p>
</div>
<div class="tool-box">
  <div class="upload-area" id="drop-zone" onclick="document.getElementById('pdfInput').click()">
    <div class="upload-icon">🇸🇦</div>
    <div class="upload-title">Drop your PDF here to Translate to Arabic</div>
...
<div style="max-width:700px;margin:0 auto 60px;padding:0 20px;text-align:center;">
  ...
  <div style="display:flex;gap:10px;flex-wrap:wrap;justify-content:center;">
    @foreach([['🇧🇩 Bengali','/pdf-translator-bengali'],['🇮🇳 Hindi','/translate-pdf-to-hindi'],['🇪🇸 Spanish','/translate-pdf-to-spanish'],['🇫🇷 French','/translate-pdf-to-french'],['🇩🇪 German','/translate-pdf-to-german'],['🌐 All Languages','/translate-pdf']] as $l)
...
<div class="faq">
  <h2>Frequently Asked Questions — PDF to Arabic Translation</h2>
...
async function processTranslate() {
    ...
    let secs = 0; result.innerHTML = '<div style="color:#8888a8;padding:20px">⏳ Translating to Arabic... <span id="timer">0s</span></div>';
    const iv = setInterval(() => { secs++; const t=document.getElementById('timer'); if(t) t.textContent=secs+'s'; }, 1000);
    const fd = new FormData(); fd.append('file', selectedFile); fd.append('language', 'Arabic'); fd.append('_token', CSRF);
...
function dlTxt() {
    ...
    const a = document.createElement('a'); a.href = URL.createObjectURL(blob); a.download = 'translation-arabic.txt'; a.click();
}
</script>
@endsection
